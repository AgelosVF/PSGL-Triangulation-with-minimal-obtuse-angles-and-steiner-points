...
public:
	...
	//Another insert method with know location
	...
	//Adds point and make the a->b line a constraint
	void insert_points_and_constraint_no_flip(const Point& a,const Point&b){
		this->Base::Ctr::insert_constraint(a,b);
	}

	void insert_constraint_no_flip(Vertex_handle a,Vertex_handle b){
		this->Base::Ctr::insert_constraint(a,b);
	}

	//remove that uses the parent class to by pass the delaunay property
