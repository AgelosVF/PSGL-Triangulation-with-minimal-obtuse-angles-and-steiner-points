...
int main(int argc,char *argv[]){
	...
	int answer;
	std::cout<<"Do you want to start with \n\t0.Old triangulation \n\t1.New triangulation\n";
	std::cin>>answer;
	...
	//---------------------TESTING GROUND------------------------------//
	if(answer==0){
		previous_triangulation(cdel_tri, region_polygon);
	}
	...
	int steiner_count=local_search(cdel_tri, region_polygon, 5000, in_domain);



	simulated_annealing(cdel_tri,region_polygon,in_domain, steiner_count, 4.9, 0.1, 100);
	std::cout<<"Afert SA\n";
